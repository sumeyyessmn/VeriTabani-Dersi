...
--
-- Anamakine: localhost
-- Üretim Zamanı: 27 Ekim 2018 saat 08:47:17
...
CREATE DATABASE `dunya` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `dunya`;
...
INSERT INTO `ulke` (`kod`, `isim`, `kita`, `kitaBolge`, `yuzolcumu`, `bagimsizlikYili`, `nufus`, `hayatBeklentisi`, `GSMH`, `eskiGSMH`, `yerelAd`, `yonetimSekli`, `idareci`, `sermaye`, `kod2`) VALUES
